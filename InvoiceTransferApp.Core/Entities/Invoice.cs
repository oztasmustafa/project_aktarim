...
namespace InvoiceTransferApp.Core.Entities
{
    public class Invoice
    {
        ...
        // Netsis grid kolonları (liste görünümü için)
        ...
        {
            return $"{InvoiceNumber} - {CustomerName} - {TotalAmount:N2} {Currency}";
        }
    }
    ...
    public class InvoiceItem
    {
        ...
        /// <summary>Üst fatura ID (FK)</summary>
